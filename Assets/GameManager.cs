...
namespace WasaaMP {
    public class GameManager : MonoBehaviourPunCallbacks {
        ...
        public NavigationOculus playerPrefabOculus;
        ...
        void Start () {
            ...
            if (playerPrefab == null) {
                ...
                if (Navigation.LocalPlayerInstance == null) {
                    ...
                    // we're in a room. spawn a character for the local player. it gets synced by using PhotonNetwork.Instantiate
                   if(PlayerPrefs.GetString("type") == "Desktop")
                    {
                        PhotonNetwork.Instantiate(this.playerPrefab.name, new Vector3(0f, 0.5f, 0f), Quaternion.identity, 0);
                    }
                    if (PlayerPrefs.GetString("type") == "Oculus")
                    {
                        PhotonNetwork.Instantiate(this.playerPrefabOculus.name, new Vector3(0f, 0f, 0f), Quaternion.identity, 0);
                    }
